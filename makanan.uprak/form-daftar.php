...
<head>
    ...
    <body>
        <div class="container" style="background: linear-gradient(90deg, #394867, #C2DEDC);">
            ...
            <form action="proses-pendaftaran.php" method="POST">
                <table>
                    ...
                    <tr>
                        <td><input type="submit" value="Daftar" name="daftar" style="color: #fff; background-color: #146C94; border-color: #AFD3E2; border-radius: 5px; padding: 2.5px 2.5px 2.5px 2.5px;" /></td>
                    </tr>
                    <tr>
                        <td>
                            <br>
