...
<head>
    ...
    <style>
        body {
            background-image: url("https://i.pinimg.com/564x/a5/bd/fc/a5bdfc95a52fc75316f12a948ffd8678.jpg");
        }
        ...
        <div class="container" style="background: linear-gradient(90deg, #394867, #3C486B);">
            ...
            <form action="proses-edit.php" method="POST">
                <table>
                    ...
                    <tr>
                        <td><input type="submit" value="Simpan" name="simpan" style="color: #fff; background-color: #146C94; border-color: #19A7CE; border-radius: 5px; padding: 2.5px 2.5px 2.5px 2.5px;" /></td>
                    </tr>
                    <tr>
                        <td>
                            <br>
