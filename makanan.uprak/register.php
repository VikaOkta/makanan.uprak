    ...
    if ($password == $cpassword) {
        ...
        if (!$result->num_rows > 0) {
            ...
            if ($result) {
                ...
                echo "<script>alert('Terjadi Kesalahan, Silakan Anda Coba Lagi!')</script>";
            }
        } else {
...
<head>
    ...
    <style>
        body {
            background-image: url("https://i.pinimg.com/564x/ce/4b/da/ce4bdac391aa7ac77410877a8eb2eaa6.jpg");
        }
    </style>
</head>
<body>
